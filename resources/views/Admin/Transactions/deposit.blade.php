...
@section('head-tag')
    <title> Create Deposit Transaction </title>
@endsection
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Deposit Transaction</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.wallets.wallets') }}">Wallets</a></li>
                        <li class="breadcrumb-item active">Create Deposit Transaction</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="col-4">
                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <p class="login-box-msg">Create Deposit Transaction</p>
                                        <form action="{{ route('admin.transactions.store', $wallet->slug)}}" method="post">
                                            @csrf
                        <input type="hidden" class="form-control form-control-sm" name="status" value="deposit">
